...
const BentoCard = ({
  ...
  >
    <div className="inset-0 h-full w-full">{background}</div>
    <div className="pointer-events-none absolute inset-0 z-10 bg-gradient-to-t from-purple-950/20 to-transparent" />
